...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'CLIENTE', v_op, NVL(:NEW.COD_CLI, :OLD.COD_CLI), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'DISTRITO', v_op, NVL(:NEW.COD_DIS, :OLD.COD_DIS), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'PROVEEDOR', v_op, NVL(:NEW.COD_PRV, :OLD.COD_PRV), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'PRODUCTO', v_op, NVL(:NEW.COD_PRO, :OLD.COD_PRO), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'ABASTECIMIENTO', v_op, v_clave, v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'VENDEDOR', v_op, NVL(:NEW.COD_VEN, :OLD.COD_VEN), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'FACTURA', v_op, NVL(:NEW.NUM_FAC, :OLD.NUM_FAC), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'DETALLE_FACTURA', v_op, v_clave, v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'ORDEN_COMPRA', v_op, NVL(:NEW.NUM_OCO, :OLD.NUM_OCO), v_desc);
END;
/
...
BEGIN
    ...
    INSERT INTO AUDITORIA (USUARIO, TABLA_AFECTADA, TIPO_OPERACION, CLAVE_REGISTRO, DESCRIPCION)
    VALUES (USER, 'DETALLE_COMPRA', v_op, v_clave, v_desc);
END;
/
